...
public class RelationshipUtil {
	...
	public static Element getUsedElementFromRelationship(Relationship relationship) {
		...
		if (relationship instanceof UsageRelationship) {
			...
			try {
				...
				System.out.println("\n ERRO NO TRY-CATCH CLASSE RELATIONSHIPUTILITY");
			}
	...
	public static Element getSuperElement(Relationship relationship) {
		if (relationship instanceof GeneralizationRelationship) {
			...
			/*
			 * }else{ System.out.println("sentença falsa");
			 */
		}
		return null;
	}
	...
	public static RealizationRelationship createNewRealizationRelationship(String relationshipName, Element client,
			Element supplier) {
		Architecture architecture = ArchitectureRepository.getCurrentArchitecture();

		RealizationRelationship realizationRelationship = new RealizationRelationship(client, supplier,
				relationshipName, UUID.randomUUID().toString());
	...
	public static GeneralizationRelationship createNewGeneralizationRelationship(Element child, Element parent) {
		...
		GeneralizationRelationship generalizationRelationship = new GeneralizationRelationship(parent, child,
				architecture.getRelationshipHolder(), UUID.randomUUID().toString());
	...
	public static UsageRelationship createNewUsageRelationship(String relationshipName, Element client,
			Element supplier) {
		// provavelmente origem do erro do Adapter
		// não é a origem do erro
		Architecture architecture = ArchitectureRepository.getCurrentArchitecture();
		UsageRelationship usage = new UsageRelationship(relationshipName, supplier, client,
	...
	public static AssociationRelationship createNewAggregationRelationship(String name, Element aggregator,
			Element aggregated) {
