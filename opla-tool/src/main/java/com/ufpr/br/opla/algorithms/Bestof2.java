...
import jmetal.experiments.Bestof2_OPLA_FeatMutInitializer;
...
public class Bestof2 {
	...
	public void execute(JComboBox comboAlgorithms, JCheckBox checkMutation, JTextField fieldMutationProb,
		...
		try {
			...
			Bestof2_OPLA_FeatMutInitializer bestof2 = new Bestof2_OPLA_FeatMutInitializer(configs);

			// Executa
			System.out.println("Execução Bestof2");
			bestof2.run();
