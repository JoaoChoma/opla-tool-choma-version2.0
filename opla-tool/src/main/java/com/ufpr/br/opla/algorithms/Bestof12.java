...
import jmetal.experiments.Bestof12_OPLA_FeatMutInitializer;
...
public class Bestof12 {
	...
	public void execute(JComboBox comboAlgorithms, JCheckBox checkMutation, JTextField fieldMutationProb,
		...
		try {
			...
			Bestof12_OPLA_FeatMutInitializer bestof12 = new Bestof12_OPLA_FeatMutInitializer(configs);

			// Executa
			System.out.println("Execução Bestof12");
			bestof12.run();
