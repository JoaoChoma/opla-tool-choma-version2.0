...
import jmetal.experiments.NoChoice_OPLA_FeatMutInitializer;
...
public class NoChoice {
	...
	public void execute(JComboBox comboAlgorithms, JCheckBox checkMutation, JTextField fieldMutationProb,
		...
		try {
			...
			NoChoice_OPLA_FeatMutInitializer noChoice = new NoChoice_OPLA_FeatMutInitializer(configs);

			// Executa
			System.out.println("Execução NoChoice");
			noChoice.run();
