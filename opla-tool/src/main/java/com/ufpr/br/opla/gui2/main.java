...
import com.ufpr.br.opla.algorithms.Bestof12;
import com.ufpr.br.opla.algorithms.Bestof2;
import com.ufpr.br.opla.algorithms.NSGAII;
import com.ufpr.br.opla.algorithms.NoChoice;
import com.ufpr.br.opla.algorithms.PAES;
import com.ufpr.br.opla.algorithms.Solution;
import com.ufpr.br.opla.algorithms.UntilBest;
...
import metrics.Wocsclass; //addYni
import metrics.Wocsinterface; //addYni
import metrics.Cbcs; //addYni
import metrics.Svc; //addYni
import metrics.Ssc; //addYni
import metrics.Av; //addYni
...
public class main extends javax.swing.JFrame {
	...
	private void createTableExecutions(String idExperiment) throws HeadlessException {
		...
		try {
			...
			for (Execution exec : all) {
				...
				// int numberNonDominatedSolutions =
				// ReadSolutionsFiles.countNumberNonDominatedSolutins(idExperiment,
	...
	private void executeNSGAII() {
		try {
			...
			Logger.getLogger().putLog(
					String.format("Error when try execute NSGA-II, Finalizing...", Level.FATAL, main.class.getName()));
			System.exit(1);
		}
	}
	...
	private void executeBestof2() {
		try {
			...
			bestof2.execute(comboAlgorithms, checkMutation, fieldMutationProb, fieldArchitectureInput, fieldNumberOfRuns,
					fieldPopulationSize, fieldMaxEvaluations, checkCrossover, fieldCrossoverProbability,
					executionDescription.getText());
		} catch (Exception e) {
			e.printStackTrace();
			JOptionPane.showMessageDialog(null, "Error when try execute Bestof2, Finalizing...." + e.getMessage());
			Logger.getLogger().putLog(
					String.format("Error when try execute Bestof2, Finalizing...", Level.FATAL, main.class.getName()));
			System.exit(1);
		}
	}
	...
	private void executePAES() {
		try {
			...
			paes.execute(comboAlgorithms, checkMutation, fieldMutationProb, fieldArchitectureInput, fieldNumberOfRuns,
					fieldPaesArchiveSize, fieldMaxEvaluations, checkCrossover, fieldCrossoverProbability,
					executionDescription.getText());

		} catch (Exception e) {
			JOptionPane.showMessageDialog(null, "Error when try execute PAES Finalizing...." + e.getMessage());
			Logger.getLogger().putLog(
					String.format("Error when try execute PAES, Finalizing...", Level.FATAL, main.class.getName()));
			System.exit(1);
		}
	}

	private void initAlgorithmsCombo() {
		//jcn inseri os nomes dos novos algoritmos
		String algoritms[] = { "Select One", "NSGA-II", "PAES", "Bestof2", "Bestof12", "NoChoice", "UntilBest" };
	...
	private void initComponents() {
        ...
        checkSvc = new javax.swing.JCheckBox();//addYni
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Profiles Configuration", 0, 0,
				...
				jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel1Layout
						...
						.addContainerGap().addGroup(jPanel1Layout
								...
								.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
										...
										.addComponent(fieldConcernProfile, javax.swing.GroupLayout.Alignment.LEADING,
												javax.swing.GroupLayout.DEFAULT_SIZE, 421, Short.MAX_VALUE))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addGroup(jPanel1Layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(btnConcernProfile).addComponent(btnPatternProfile)
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout
						...
						.addGroup(jPanel2Layout.createSequentialGroup()
								.addComponent(fieldTemplate, javax.swing.GroupLayout.PREFERRED_SIZE, 319,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(18, 18, 18)
								.addComponent(btnTemplate, javax.swing.GroupLayout.PREFERRED_SIZE, 1, Short.MAX_VALUE)))
						.addContainerGap()));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addComponent(jLabel7).addGap(0, 0, Short.MAX_VALUE))
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addComponent(jLabel8)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(fieldTemplate, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(btnTemplate))
						.addContainerGap()));

		jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Manipulation Directory", 0, 0,
				new java.awt.Font("Verdana", 1, 14), java.awt.Color.magenta)); // NOI18N
				...
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap()
						.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
										jPanel3Layout.createSequentialGroup().addComponent(jLabel15)
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(jLabel14))
								.addGroup(jPanel3Layout.createSequentialGroup()
										.addComponent(fieldManipulationDir, javax.swing.GroupLayout.PREFERRED_SIZE, 332,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		ApplicationConfsLayout.setHorizontalGroup(ApplicationConfsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(ApplicationConfsLayout.createSequentialGroup().addGap(23, 23, 23)
						.addGroup(ApplicationConfsLayout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(jButton1).addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addContainerGap(390, Short.MAX_VALUE)));
		ApplicationConfsLayout
				.setVerticalGroup(ApplicationConfsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(ApplicationConfsLayout.createSequentialGroup().addContainerGap()
								.addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGap(18, 18, 18)
								...
								.addComponent(jPanel3, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(44, 44, 44).addComponent(jButton1).addGap(29, 29, 29)));

		jTabbedPane1.addTab("General Configurations", ApplicationConfs);

		algorithms.setName("algorithms");

		panelExperimentSettings.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Settings", 0, 0,
				new java.awt.Font("Verdana", 1, 14), java.awt.Color.magenta)); // NOI18N
		...
		panelCrossProbLayout
				.setHorizontalGroup(panelCrossProbLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								panelCrossProbLayout.createSequentialGroup()
										.addComponent(crossProbSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addComponent(fieldCrossoverProbability, javax.swing.GroupLayout.PREFERRED_SIZE,
												30, javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(jLabel6).addGap(151, 151, 151)));
		panelCrossProbLayout.setVerticalGroup(panelCrossProbLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelCrossProbLayout.createSequentialGroup().addContainerGap().addGroup(panelCrossProbLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(crossProbSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 55,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGroup(panelCrossProbLayout.createSequentialGroup().addComponent(jLabel6)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(fieldCrossoverProbability, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		panelMutationProbLayout.setHorizontalGroup(
				panelMutationProbLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelMutationProbLayout.createSequentialGroup().addContainerGap()
								.addComponent(mutatinProbSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 150,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(fieldMutationProb, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		panelMutationProbLayout.setVerticalGroup(panelMutationProbLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelMutationProbLayout.createSequentialGroup().addGap(4, 4, 4)
						.addGroup(panelMutationProbLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(mutatinProbSlider, javax.swing.GroupLayout.PREFERRED_SIZE, 55,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(panelMutationProbLayout.createSequentialGroup().addGap(11, 11, 11)
										.addComponent(fieldMutationProb, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
						...
						panelMetricsLayout
								...
								.addGroup(
										...
										.addGroup(panelMetricsLayout
												...
												.addComponent(checkWocsClass)//addYni
												.addComponent(checkCbcs)//addYni
									...
									.addGroup(panelMetricsLayout
											...
											.addComponent(checkWocsInterface)//addYni
						                    .addComponent(checkSvc)//addYni
						                    .addComponent(checkAv)//addYni
		...
		panelMetricsLayout
				.setVerticalGroup(panelMetricsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelMetricsLayout.createSequentialGroup().addGap(20, 20, 20).addGroup(
								panelMetricsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
/*
		...
		panelOperatorsMutationLayout.setVerticalGroup(
				panelOperatorsMutationLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelOperatorsMutationLayout.createSequentialGroup().addContainerGap()
								.addGroup(panelOperatorsMutationLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(checkFeatureMutation).addComponent(checkMoveOperation))
								.addGap(5, 5, 5)
								.addGroup(panelOperatorsMutationLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(checkMoveMethod).addComponent(checkManagerClass))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(panelOperatorsMutationLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
*/
		...
		panelExperimentSettingsLayout.setHorizontalGroup(
				panelExperimentSettingsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelExperimentSettingsLayout.createSequentialGroup().addContainerGap()
								.addGroup(panelExperimentSettingsLayout.createParallelGroup(
										javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(panelExperimentSettingsLayout.createSequentialGroup()
												...
												.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
												.addComponent(panelMutationProb,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(panelExperimentSettingsLayout.createSequentialGroup()
												.addGroup(
														panelExperimentSettingsLayout
																.createParallelGroup(
																		javax.swing.GroupLayout.Alignment.LEADING)
																...
																.addGroup(panelExperimentSettingsLayout
																		...
																		.addComponent(checkMutation).addGap(18, 18, 18)
																		.addComponent(checkCrossover))
																.addComponent(labelAlgorithms))
												.addGap(136, 136, 136)
												.addGroup(panelExperimentSettingsLayout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
														.addComponent(panelMetrics,
																javax.swing.GroupLayout.PREFERRED_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE)
														.addComponent(panelOperatorsMutation,
																...
																javax.swing.GroupLayout.PREFERRED_SIZE))))
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		panelExperimentSettingsLayout.setVerticalGroup(panelExperimentSettingsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelExperimentSettingsLayout.createSequentialGroup().addGroup(panelExperimentSettingsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelExperimentSettingsLayout.createSequentialGroup().addContainerGap()
								.addComponent(labelAlgorithms)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(comboAlgorithms, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(panelExperimentSettingsLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel3).addComponent(fieldNumberOfRuns,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(panelExperimentSettingsLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(jLabel4).addComponent(fieldMaxEvaluations,
												javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addGroup(panelExperimentSettingsLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addGroup(panelExperimentSettingsLayout.createSequentialGroup().addGap(8, 8, 8)
												.addComponent(jLabel5).addGap(18, 18, 18).addComponent(labelArchivePAES)
										...
										.addGroup(panelExperimentSettingsLayout.createSequentialGroup()
												...
												.addComponent(fieldPopulationSize,
														...
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addGap(5, 5, 5).addComponent(fieldPaesArchiveSize,
														javax.swing.GroupLayout.PREFERRED_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.PREFERRED_SIZE)))
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(labelOperators, javax.swing.GroupLayout.PREFERRED_SIZE, 22,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addGroup(panelExperimentSettingsLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
										.addComponent(checkCrossover, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(checkMutation)))
						.addGroup(panelExperimentSettingsLayout.createSequentialGroup()
								.addComponent(panelMetrics, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Select where you want to save outputs", 0,
				0, new java.awt.Font("Verdana", 1, 14), java.awt.Color.magenta)); // NOI18N
				...
				.setHorizontalGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
								...
								.addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
										.addComponent(btnOutput).addComponent(fieldOutput,
		...
		jPanel8Layout.setVerticalGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel8Layout.createSequentialGroup().addContainerGap()
						.addComponent(fieldOutput, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(btnOutput).addContainerGap()));
		...
		algorithmsLayout.setHorizontalGroup(algorithmsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(algorithmsLayout.createSequentialGroup().addGap(12, 12, 12).addGroup(algorithmsLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(panelExperimentSettings, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								...
								.addGroup(algorithmsLayout
										...
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												algorithmsLayout
														...
														.addComponent(executionDescription,
																javax.swing.GroupLayout.PREFERRED_SIZE, 177,
																javax.swing.GroupLayout.PREFERRED_SIZE))
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
												algorithmsLayout.createSequentialGroup()
										...
										.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, algorithmsLayout
												.createSequentialGroup().addComponent(btnRun).addGap(21, 21, 21)))))));
		algorithmsLayout.setVerticalGroup(algorithmsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(algorithmsLayout.createSequentialGroup().addContainerGap()
						.addComponent(panelExperimentSettings, javax.swing.GroupLayout.PREFERRED_SIZE, 409,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(algorithmsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jPanel7, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGroup(algorithmsLayout.createSequentialGroup().addGap(6, 6, 6)
										.addComponent(jPanel8, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										...
										.addGroup(algorithmsLayout
												...
												.addGroup(algorithmsLayout.createSequentialGroup()
														...
														.addComponent(executionDescription,
																...
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE))
												.addGroup(algorithmsLayout.createSequentialGroup().addGap(34, 34, 34)
		...
		jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Design Pattern Selection Strategy", 0, 0,
		...
		jPanel5Layout.setHorizontalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel5Layout.createSequentialGroup().addGap(18, 18, 18)
						.addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(checkBridge).addComponent(checkStrategy).addComponent(checkMediator))
						.addContainerGap(226, Short.MAX_VALUE)));
		jPanel5Layout.setVerticalGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel5Layout.createSequentialGroup().addGap(14, 14, 14).addComponent(checkMediator)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(checkStrategy)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(checkBridge)
						.addContainerGap(21, Short.MAX_VALUE)));

		panelPatternScope.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Scope Selection Strategy", 0, 0,
				new java.awt.Font("Verdana", 1, 14), new java.awt.Color(255, 0, 255))); // NOI18N
		...
		panelPatternScopeLayout.setHorizontalGroup(panelPatternScopeLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelPatternScopeLayout.createSequentialGroup().addContainerGap()
						.addGroup(panelPatternScopeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(radioRandomStrategy).addComponent(radioElementsWithSameDPorNone))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		panelPatternScopeLayout
				.setVerticalGroup(panelPatternScopeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelPatternScopeLayout.createSequentialGroup().addGap(15, 15, 15)
		...
		jPanel4Layout.setHorizontalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addGap(18, 18, 18)
						.addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addComponent(panelPatternScope, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(258, Short.MAX_VALUE)));
		jPanel4Layout.setVerticalGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel4Layout.createSequentialGroup().addGap(31, 31, 31)
						.addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
								.addComponent(panelPatternScope, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		panelExecutionsLayout.setHorizontalGroup(panelExecutionsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelExecutionsLayout.createSequentialGroup().addGap(15, 15, 15)
						.addGroup(panelExecutionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(jLabel16, javax.swing.GroupLayout.PREFERRED_SIZE, 120,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 465,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addContainerGap(75, Short.MAX_VALUE)));
		panelExecutionsLayout.setVerticalGroup(panelExecutionsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelExecutionsLayout.createSequentialGroup().addComponent(jLabel16).addGap(14, 14, 14)
		...
		panelSolutionsLayout
				.setHorizontalGroup(panelSolutionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								panelSolutionsLayout.createSequentialGroup().addGap(15, 15, 15).addComponent(jLabel17)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 83,
												Short.MAX_VALUE)
										.addComponent(comboSolutions, javax.swing.GroupLayout.PREFERRED_SIZE, 415,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addContainerGap()));
		panelSolutionsLayout.setVerticalGroup(panelSolutionsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelSolutionsLayout.createSequentialGroup()
						.addGroup(panelSolutionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(jLabel17).addComponent(comboSolutions,
										javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(0, 10, Short.MAX_VALUE)));

		tableObjectives.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
		...
		panelObjectivesLayout
				.setHorizontalGroup(panelObjectivesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelObjectivesLayout.createSequentialGroup().addGap(15, 15, 15).addComponent(jLabel9)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(comboMetrics, javax.swing.GroupLayout.PREFERRED_SIZE, 234,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(0, 0, Short.MAX_VALUE))
						.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
								panelObjectivesLayout.createSequentialGroup()
										.addContainerGap().addComponent(jScrollPane4,
												javax.swing.GroupLayout.DEFAULT_SIZE, 544, Short.MAX_VALUE)
										.addContainerGap()));
		panelObjectivesLayout.setVerticalGroup(panelObjectivesLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelObjectivesLayout.createSequentialGroup()
						...
						.addGroup(panelObjectivesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(comboMetrics, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		panelShowMetricsLayout.setHorizontalGroup(
				panelShowMetricsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(panelShowMetricsLayout.createSequentialGroup().addContainerGap()
								.addComponent(jScrollPane5, javax.swing.GroupLayout.PREFERRED_SIZE, 725,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addContainerGap(20, Short.MAX_VALUE))
						.addGroup(panelShowMetricsLayout.createSequentialGroup().addComponent(bestSolutions).addGap(0,
								0, Short.MAX_VALUE)));
		panelShowMetricsLayout.setVerticalGroup(panelShowMetricsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelShowMetricsLayout.createSequentialGroup().addContainerGap()
						.addComponent(jScrollPane5, javax.swing.GroupLayout.PREFERRED_SIZE, 83,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18).addComponent(bestSolutions)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		...
		experimentsLayout
				.setHorizontalGroup(experimentsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(experimentsLayout.createSequentialGroup()
								.addContainerGap().addGroup(experimentsLayout
										.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
												experimentsLayout.createSequentialGroup().addGroup(experimentsLayout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														...
														.addGap(18, 18, 18).addComponent(
																panelExecutions, javax.swing.GroupLayout.PREFERRED_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.PREFERRED_SIZE))
										.addComponent(panelObjectives, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(panelShowMetrics, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE)
										.addComponent(panelSolutions, javax.swing.GroupLayout.PREFERRED_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		experimentsLayout.setVerticalGroup(experimentsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(experimentsLayout.createSequentialGroup().addContainerGap()
						.addGroup(experimentsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(experimentsLayout.createSequentialGroup()
										.addGroup(experimentsLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
												.addComponent(btnShowConfigurations).addComponent(jLabel13))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
										.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 211,
												javax.swing.GroupLayout.PREFERRED_SIZE))
								.addComponent(panelExecutions, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18)
						.addComponent(panelSolutions, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGap(1, 1, 1)
						.addComponent(panelObjectives, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		panelFunctionExecutionsSelecteds
				.setBorder(javax.swing.BorderFactory.createTitledBorder("Solutions in the Search Space"));
		...
		javax.swing.GroupLayout panelFunctionExecutionsSelectedsLayout = new javax.swing.GroupLayout(
				panelFunctionExecutionsSelecteds);
		panelFunctionExecutionsSelecteds.setLayout(panelFunctionExecutionsSelectedsLayout);
		panelFunctionExecutionsSelectedsLayout.setHorizontalGroup(panelFunctionExecutionsSelectedsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelFunctionExecutionsSelectedsLayout.createSequentialGroup().addContainerGap()
						.addComponent(jButton2).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(btnGenerateChart).addContainerGap(115, Short.MAX_VALUE)));
		panelFunctionExecutionsSelectedsLayout.setVerticalGroup(panelFunctionExecutionsSelectedsLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(panelFunctionExecutionsSelectedsLayout.createSequentialGroup()
						.addGroup(panelFunctionExecutionsSelectedsLayout
		...
		jPanel10Layout.setHorizontalGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel10Layout.createSequentialGroup().addContainerGap().addComponent(btnHypervolume)
						.addGap(18, 18, 18).addComponent(hypervolumeNormalized)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
		jPanel10Layout.setVerticalGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
						.addComponent(btnHypervolume).addComponent(hypervolumeNormalized)));
		...
		jPanel11Layout.setHorizontalGroup(
				jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(jPanel11Layout
						.createSequentialGroup().addComponent(btnGenerateEdChart).addGap(0, 0, Short.MAX_VALUE)));
				...
				.addGroup(jPanel9Layout.createSequentialGroup().addContainerGap().addGroup(jPanel9Layout
						...
						.addGroup(jPanel9Layout.createSequentialGroup()
								.addComponent(jScrollPane7, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addComponent(panelFunctionExecutionsSelecteds, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		jPanel9Layout.setVerticalGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel9Layout.createSequentialGroup().addContainerGap()
						.addComponent(jScrollPane7, javax.swing.GroupLayout.PREFERRED_SIZE, 211,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
						.addComponent(jPanel11, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		jPanel6Layout.setVerticalGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel6Layout.createSequentialGroup().addGap(7, 7, 7).addComponent(jLabel12)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(jScrollPane6, javax.swing.GroupLayout.PREFERRED_SIZE, 382,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addGap(18, 18, 18)
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 990,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
	...
	private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
		...
		sb.append("pathToProfileRelationships: ").append(config.getConfig().getPathToProfileRelationships())
				.append("\n");
		sb.append("pathToTemplateModelsDirectory: ").append(config.getConfig().getPathToTemplateModelsDirectory())
				.append("\n");
	...
	private void comboAlgorithmsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_comboAlgorithmsActionPerformed
		if (comboAlgorithms.getSelectedItem() != null && comboAlgorithms.getSelectedIndex() != 0) {
			...
			if ("Bestof2".equalsIgnoreCase(algorithmName)) {
				enableFieldsForNSGAII();
				hideFieldsForPases();
			}
			if ("Bestof12".equalsIgnoreCase(algorithmName)) {
				enableFieldsForNSGAII();
				hideFieldsForPases();
			}
			if ("NoChoice".equalsIgnoreCase(algorithmName)) {
				enableFieldsForNSGAII();
				hideFieldsForPases();
			}
			if ("UntilBest".equalsIgnoreCase(algorithmName)) {
				enableFieldsForNSGAII();
				hideFieldsForPases();
			}
    ...
    private void checkLCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkEleganceActionPerformed
    	System.out.println("Feature-based Cohesion");
...
//addYni----------------------------------------
	...
	private void btnRunActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnRunActionPerformed
		...
		if (comboAlgorithms.getSelectedIndex() == 0) {
			...
			if (dialogResult == 0) {
				...
				if ("Bestof2".equalsIgnoreCase(algoritmToRun)) {
					SwingWorker sw = new SwingWorker() {

						@Override
						protected Object doInBackground() throws Exception {
							jLabel12.setText("Working... wait. Started " + Time.timeNow());
							Logger.getLogger().putLog("Execution Bestof2...");
							jTabbedPane1.setSelectedIndex(5);
							btnRun.setEnabled(false);
							blockUITabs();
							executeBestof2();
						...
						protected void done() {
							...
							progressBar.setIndeterminate(false);
							Logger.getLogger()
									.putLog(String.format("Done Bestof2 Execution at: %s", Time.timeNow().toString()));
							db.Database.reloadContent();
						}
					};
				...
				if ("Bestof12".equalsIgnoreCase(algoritmToRun)) {
					SwingWorker sw = new SwingWorker() {
						...
						protected Object doInBackground() throws Exception {
							jLabel12.setText("Working... wait. Started " + Time.timeNow());
							Logger.getLogger().putLog("Execution Bestof12...");
							jTabbedPane1.setSelectedIndex(5);
							btnRun.setEnabled(false);
							blockUITabs();
							executeBestof12();
						...
						protected void done() {
							...
							progressBar.setIndeterminate(false);
							Logger.getLogger()
									.putLog(String.format("Done Bestof12 Execution at: %s", Time.timeNow().toString()));
							db.Database.reloadContent();
						}
					};
				...
				if ("NoChoice".equalsIgnoreCase(algoritmToRun)) {
					SwingWorker sw = new SwingWorker() {
						...
						protected Object doInBackground() throws Exception {
							jLabel12.setText("Working... wait. Started " + Time.timeNow());
							Logger.getLogger().putLog("Execution NoChoice...");
							jTabbedPane1.setSelectedIndex(5);
							btnRun.setEnabled(false);
							blockUITabs();
							executeNoChoice();
						...
						protected void done() {
							...
							progressBar.setIndeterminate(false);
							Logger.getLogger()
									.putLog(String.format("Done NoChoice Execution at: %s", Time.timeNow().toString()));
							db.Database.reloadContent();
						}
					};
				...
				if ("UntilBest".equalsIgnoreCase(algoritmToRun)) {
					SwingWorker sw = new SwingWorker() {
						...
						protected Object doInBackground() throws Exception {
							jLabel12.setText("Working... wait. Started " + Time.timeNow());
							Logger.getLogger().putLog("Execution UntilBest...");
							jTabbedPane1.setSelectedIndex(5);
							btnRun.setEnabled(false);
							blockUITabs();
							executeUntilBest();
						...
						protected void done() {
							...
							progressBar.setIndeterminate(false);
							Logger.getLogger()
									.putLog(String.format("Done UntilBest Execution at: %s", Time.timeNow().toString()));
							db.Database.reloadContent();
						}
					};
	...
	private void tableExpMouseClicked(java.awt.event.MouseEvent evt) {// GEN-FIRST:event_tableExpMouseClicked
		if (evt.getClickCount() == 2) {
			...
			GuiUtils.hideSolutionsAndExecutionPaneIfExperimentSelectedChange(this.selectedExperiment, idExperiment,
					panelSolutions, panelObjectives);
	...
	private void comboSolutionsActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_comboSolutionsActionPerformed
		...
		Map<String, String> objectives = db.Database.getAllObjectivesByExecution(
				((Solution) comboSolutions.getSelectedItem()).getId(), this.selectedExperiment);
	...
	private void comboMetricsItemStateChanged(java.awt.event.ItemEvent evt) {// GEN-FIRST:event_comboMetricsItemStateChanged
		...
		String[] conventionalsColumns = { "macAggregation", "choesion", "meanDepComps", "meanNumOps", "sumClassesDepIn",
	    ...
	    String[] svcColumns = {"SVC"};//addYni
	    String[] sscColumns = {"SSC"};//addYni
	    String[] avColumns = {"AV"};//addYni
	    String[] lccColumns = {"LCC"};
		...
		mapColumns.put("svc", svcColumns);//addYni
		...
		if (comboSolutions.getSelectedItem() != null) {
			String idSolution = Utils
					.extractSolutionIdFromSolutionFileName(comboSolutions.getSelectedItem().toString());
			...
			if (selectedMetric.equalsIgnoreCase("plaextensibility")) {
				...
				Conventional conventional = db.Database.getConventionalsMetricsForSolution(idSolution,
			...
			//---addYni---
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("wocsclass")[i]);
		            numberOfColumns++;
		          }

		          Object[] row = new Object[numberOfColumns + 3];
		          row[0] = wocsc.getWocsClass();
		          row[1] = this.selectedExperiment;
		          row[2] = this.selectedExecution;
		          model.addRow(row);
		        } 
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("wocsinterface")[i]);
		            numberOfColumns++;
		          }

		          Object[] row = new Object[numberOfColumns + 2];
		          row[0] = wocsI.getWocsInterface();
		          row[1] = this.selectedExperiment;
		          row[2] = this.selectedExecution;
		          model.addRow(row);
		        } 
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("cbcs")[i]);
		            numberOfColumns++;
		          }
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("svc")[i]);
		            numberOfColumns++;
		          }
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("ssc")[i]);
		            numberOfColumns++;
		          }
		          ...
		          for (int i = 0; i < mapColumns.get(selectedMetric).length; i++) {
		            model.addColumn(mapColumns.get("av")[i]);
		            numberOfColumns++;
		          }
	...
	private void checkManagerClassActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_checkManagerClassActionPerformed
		addOrRemoveOperatorMutation(FeatureMutationOperators.ADD_MANAGER_CLASS_MUTATION.getOperatorName(),
				checkManagerClass);
    ...
    private javax.swing.JCheckBox checkSvc;//addYni
    private javax.swing.JCheckBox checkSsc;//addYni
    private javax.swing.JCheckBox checkAv;//addYni
    private javax.swing.JCheckBox checkLCC;
...
//		}
		...
		checkSvc.setSelected(false);//addYni
		checkSsc.setSelected(false);//addYni
		checkAv.setSelected(false);//addYni
		checkLCC.setSelected(false);
	}
	...
	private void configureDb() {
		...
		try {
			...
			Logger.getLogger()
					.putLog(String.format(String.format(String.format("Error ConfigureDB %s", ex.getMessage())),
							Level.INFO, main.class.getName()));
			System.exit(1);
		} catch (Exception ex) {
			Logger.getLogger()
					.putLog(String.format(
							String.format(String.format(String.format("Generic ERROR %s", ex.getMessage()))),
							Level.INFO, main.class.getName()));
			System.exit(1);
		}
