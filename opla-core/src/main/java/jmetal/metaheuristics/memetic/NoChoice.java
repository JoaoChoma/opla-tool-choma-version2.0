...
//		File f = new File("selecao-NoChoice.txt");
//		f.createNewFile();
		File t = new File("tempo-NoChoice.txt");
		t.createNewFile();
		File a = new File("aplicacao-NoChoice.txt");
		a.createNewFile();
	}

	public void gravarTempo(long valor) throws IOException {
		FileWriter t = new FileWriter("tempo-NoChoice.txt", true);
...
//
	public void gravarAplicacao(String input) throws IOException {
		FileWriter t = new FileWriter("aplicacao-NoChoice.txt", true);
		t.write("\n " + input);
		t.close();
	}
