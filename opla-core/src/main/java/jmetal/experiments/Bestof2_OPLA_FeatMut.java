...
public class Bestof2_OPLA_FeatMut {
	...
	public Bestof2_OPLA_FeatMut(NSGAIIConfig config) {
		this.configs = config;
	}

	public Bestof2_OPLA_FeatMut() {
	}
	...
	public void execute() throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
		...
		for (String pla : plas) {
			...
			Experiment experiement = mp.createExperimentOnDb(plaName, "Bestof2", configs.getDescription());
