...
import jmetal.metaheuristics.memetic.NoChoice;
...
public class NoChoice_OPLA_FeatMut {
	...
	public NoChoice_OPLA_FeatMut(NSGAIIConfig config) {
		this.configs = config;
	}

	public NoChoice_OPLA_FeatMut() {
	}
	...
	public void execute() throws FileNotFoundException, IOException, JMException, ClassNotFoundException {
		...
		for (String pla : plas) {
			...
			Experiment experiement = mp.createExperimentOnDb(plaName, "NoChoice", configs.getDescription());
