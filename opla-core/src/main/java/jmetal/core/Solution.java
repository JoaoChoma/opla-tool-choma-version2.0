...
public class Solution implements Serializable {
	...
	/*
	 * public Variable deepCopy() { return this.deepClone(); }
	 * 
	 * // private static int count = 1; public Architecture deepClone() { if
	 * (cloner == null) cloner = new Cloner(); Architecture newArchitecture =
	 * cloner.deepClone(this); return newArchitecture; }
	 * 
	 * public void setCloner(Cloner cloner) { this.cloner = cloner; }
	 */
