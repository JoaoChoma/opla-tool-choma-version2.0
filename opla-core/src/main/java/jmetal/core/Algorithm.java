...
public abstract class Algorithm implements Serializable {
	...
	private static final long serialVersionUID = 7081956650977071720L;
	...
	protected Map<String, Operator> operatorsLocal_ = null;
	...
	public void addOperatorLocal(String name, Operator operatorLocal) {
		if (operatorsLocal_ == null) {
			operatorsLocal_ = new HashMap<String, Operator>();
		}
		operatorsLocal_.put(name, operatorLocal);
	...
	public Operator getOperatorLocal(String name) {
		return operatorsLocal_.get(name);
	} // getOperator
	/**
